...
function color_task_failure_steps(stepFunction: StepFunction): string {
  const step_names: string[] = Object.keys(stepFunction.States)
  let failure_steps_colors : string = "";
